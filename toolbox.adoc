...
It should be noted that the toolbox as contained in this document focuses on a functional approach of testing as required by the assurance component ATE_FUN.1. For this reason, it only addresses the tests as performed by the evaluation laboratory. 
