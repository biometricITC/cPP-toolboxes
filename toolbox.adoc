...
|Suggestions that evaluator should consider to device penetration tests from this test and attack potential rating that the evaluator shall use for AVA_VAN.1 evaluation for those penetration tests 
