...
== Attack type
Face, printed HR photo attack on face

==== Total Number of Species
This attack has *1* species to be tested.

== Overview
A printed High Resolution photo of the user’s full face is applied to the attacker’s face and presented to the TOE.
...
== Recipe
. Attacker takes user’s photo image using High Resolution camera and prints it on regular paper.
