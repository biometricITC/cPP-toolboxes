...
== Overview
A printed photo of the user’s full face is applied to the attacker’s face and presented to the TOE.
...
== Recipe
. Attacker takes a picture of the user using digital Camera (front facing mobile camera) and prints it on regular paper.
