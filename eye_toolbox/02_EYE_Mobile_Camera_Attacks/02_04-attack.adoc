...
== Overview
_This scenario is same as No. 02_01 except normal quality of user’s image is used with professional photo printing are used instead of the low quality ones._
