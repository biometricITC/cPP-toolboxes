...
=== Attack type
Digital photo attack, High quality

== Overview
The evaluator caputures and displays target user's face on a high resolution screen and present it to the TOE.

== Input
Target user's face

== Tools
Type 2 tools in <<2DFaceInventory>> except T.2 (Printer) and T.3 (Print paper)

== Recipe
The evaluator shall capture a face image and display it on a high resolution screen. 
...
== Presentation
The evaluator shall present a high resolution screen by hand as described in <<2DFaceOverview>>.
