...
The evaluator shall refer publicly available information to change default setting of the camera (e.g. shutter speed) and printer (e.g. resolution) to create clearer face artefacts.
